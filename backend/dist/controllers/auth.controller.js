...
class AuthController {
    constructor() {
            ...
            cognitoService
                ...
                if (result) {
                    ...
                    try {
                        ...
                        res.status(500).json({
                            message: "User registration successful, but failed to store user information",
                        });
                    }
                }
                else {
        ...
        this.signIn = (req, res) => {
            ...
            cognitoService
                ...
                console.error(errorMessage, "the final decesion made that need send to front end");
    ...
    validateBody(type) {
        switch (type) {
            ...
            case "signIn":
                return [
                    (0, express_validator_1.body)("username").notEmpty().isLength({ min: 0 }),
                    (0, express_validator_1.body)("password").isString().isLength({ min: 0 }),
                ];
            case "verify":
                return [
            ...
            case "confirmPassword":
                return [
                    (0, express_validator_1.body)("newPassword").exists().isLength({ min: 8 }),
                    (0, express_validator_1.body)("username").notEmpty().isLength({ min: 5 }),
                    (0, express_validator_1.body)("code").notEmpty().isString().isLength({ min: 6, max: 6 }),
                ];
            case "verifyCode":
