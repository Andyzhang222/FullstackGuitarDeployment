...
const HomepageProductSuggestion = () => {
    ...
    const fetchProducts = async () => {
        try {
            const response = await fetch(`${config_1.default}:5001/api/products?limit=10`);
            if (!response.ok) {
...
exports.default = HomepageProductSuggestion;
//# sourceMappingURL=FeaturedProductDisplay.js.map